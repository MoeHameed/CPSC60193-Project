...
public class WifiScanner {
    ...
    public static class ScanData implements Parcelable {
        ...
        public ScanResult[] getResults() {
            String my_tag = "MOES_TAG";
            String log1 = "SCAN DATA IS RETURNING " + String.valueOf(mResults.length) + " SCAN RESULTS !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!";
            Log.i(my_tag, log1);
            
            // // for (int i = 0; i < mResults.length; i++) {
            // //     Log.i(my_tag, mResults[i].toString());
            // // }

            // try {
            //     FileWriter myWriter = new FileWriter("/java_test.txt");
            //     myWriter.write("Files in Java might be tricky, but it is fun enough!");
            //     myWriter.close();
            // } catch (IOException e) {
            //     Log.i(my_tag, "ERROR WITH WRITING FILE");
            //     Log.i(my_tag, e.toString());
            // }
            
            // Log.i(my_tag, "SCAN DATA IS DONE");
